...
namespace Web_Forum.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<User> signInManager, ILogger<LoginModel> logger, IUserStore<User> userStore)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = await _userStore.FindByEmailAsync(Input.Email, CancellationToken.None);
